                ...
                <CustomScrollbar>
                    ...
                    <section>
                        ...
                        <div
                            ...
                            <div v-if="systemStore.systems.length === 0" class="p-6 text-center text-gray-500 italic">
                    ...
                    <section>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <UBadge color="sky" variant="subtle">{{ componentStore.defaultComponents.length }}</UBadge>
                        </div>
                        <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700 h-48">
                        <CustomScrollbar>
                            <div v-for="comp in componentStore.defaultComponents" :key="comp.id"
                            ...
                            <div v-if="componentStore.defaultComponents.length === 0" class="p-6 text-center text-gray-500 italic">
                    ...
                    <section>
                        ...
                        <div class="p-3 bg-teacher-500/5 border border-teacher-500/20 rounded-lg text-xs space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="font-mono font-bold"
                                    ...
                                    <small v-if="systemStore.selectedSystemId" class="text-gray-400 ml-1">({{ typeof
                            ...
                            <div class="flex justify-between border-t border-teacher-500/10 pt-2">
                                ...
                                <UBadge :color="systemStore.selectedSystem ? 'green' : 'red'" variant="subtle" size="xs">
                    ...
                    <section v-if="systemStore.selectedSystem">
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <UBadge color="sky" variant="subtle">{{ systemStore.selectedSystem.actualComponents.length }}</UBadge>
                        </div>
                        <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700 h-48">
                        <CustomScrollbar>
                            ...
                            <div v-if="systemStore.selectedSystem.actualComponents.length === 0" class="p-6 text-center text-gray-500 italic">
