<template>
    <div class="highlightable" :id="componentId"
        ...
        <div class="supervisors-wrapper">
            <div v-if="supervisorsData.length > 0" class="supervisors-list space-y-2">
                <div v-for="supervisor in supervisorsData" :key="supervisor.id" class="supervisor-item">
...
// Constants
const componentId = 'session-supervisors-list'
...
const correctSqlQuery = computed(() => sessionSupervisorsComponent.value?.sql?.['sql-1'] || ``)
